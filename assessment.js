...
// CODE HERE
let myFriends = ['Lol', 'Why', 'Would', 'I put my friends here'];

// #6 Add a fifth friends name to the end of your myFriends array

// CODE HERE
myFriends.push('Miguel');
...
var trueFriends = peopleIknow.filter((el, i, arr)=>{
  return el.friend;
});
